...
function adicionaItem(src0,src1) {
  ...
  */var imagens = [];
  ...
  imagens[0].alt = "crash";
  imagens[1].alt = "crash";
  imagens[0].className = "sideoption optionimage";
  imagens[1].className = "sideoption optionimage";
  ...
  title[1] = src1.split("/");
  title[1] = title[1][title[1].length - 1].split(".")[0];
